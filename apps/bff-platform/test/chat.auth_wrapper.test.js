...
const { createMockCommons, createMockDb } = require('@niyati/commons/test/helpers');
...
describe('chat auth wrapper behavior', () => {
  ...
  beforeEach(() => {
    ...
    jest.mock('@niyati/commons', () => require('@niyati/commons/test/helpers').createMockCommons({}));
