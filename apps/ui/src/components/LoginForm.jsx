  ...
  return (
    <div className="w-full max-w-md bg-slate-900/80 backdrop-blur-md border border-slate-700 rounded-2xl shadow-2xl p-8 z-10 text-center">
      <div className="flex flex-wrap gap-2 justify-center mb-4">
        <button type="button" onClick={() => window.location.href = '/api/v1/auth/google'} className="flex-1 min-w-[120px] px-3 py-2 bg-white/5 rounded-lg text-white hover:bg-white/10 transition-colors text-sm">Google</button>
        <button type="button" onClick={() => window.location.href = '/api/v1/auth/github'} className="flex-1 min-w-[120px] px-3 py-2 bg-white/5 rounded-lg text-white hover:bg-white/10 transition-colors text-sm">GitHub</button>
        <button type="button" onClick={() => window.location.href = '/api/v1/auth/apple'} className="flex-1 min-w-[120px] px-3 py-2 bg-white/5 rounded-lg text-white hover:bg-white/10 transition-colors text-sm">Apple</button>
      </div>
