-- Baseline migration (with is_adult): create final schema for fresh installs
-- Date: 2026-01-04
...
CREATE TABLE users (
  ...
  -- New flag persisted for convenience
...
-- Notes:
-- This baseline replaces the earlier baseline for fresh installs and includes the `is_adult` column.
-- WARNING: This migration is destructive for existing databases. For production upgrades, follow a controlled migration plan and backups.
